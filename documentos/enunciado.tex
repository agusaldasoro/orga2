...
\end{figure}
\newpage
\indent Siendo el Caso 1 las mediciones de esperanza y Desvío Standar para todos los casos de test y el Caso 2 las mediciones sin tener en cuenta los cuatro outliers.\\
